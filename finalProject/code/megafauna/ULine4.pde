// life expectancy version of ULine

class ULine4 extends ULine {
  ...
  void display() {
    ...
    if (animateLine) {
      ...
      for (int i = 0 + animationIndex2; i < animationIndex; i++) {
        ...
        //println(i);
        if (forward) {
          wave.setFrequency(animationIndex*10.0+10.0);
        } else {
          wave.setFrequency((verticesNb - animationIndex2)*10.0+10.0);
        }
